...
class PhiNetTransform():
    def __init__(self, image_size, mean_std=imagenet_mean_std, apply_flip=True, apply_rotation=False, rotation_range=(0, 360), imagenet=False):
        ...
        if apply_rotation:
            transforms_list.append(T.RandomRotation(degrees=rotation_range))
