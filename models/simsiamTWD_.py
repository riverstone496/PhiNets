...
def kl_twd_loss(features1, features2, pe, Bw, lam=0.1,temperature = 0.1,model='DCTSPEM'):
...
class SimSiamTWD(nn.Module):
    def __init__(self,pe,Bw,backbone=resnet50()):
        super().__init__()
    ...
    def forward(self, x1, x2):
        ...
        L1 = kl_twd_loss(p1, p2, self.pe, self.Bw)
        L2 = kl_twd_loss(p2, z2.detach(), self.pe, self.Bw)
        L3 = kl_twd_loss(p2, z1.detach(), self.pe, self.Bw)
        #L3 = kl_twd_loss(p2, z2.detach(), self.pe, self.Bw)
