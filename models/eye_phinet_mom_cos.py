...
class EyePhiNetMomCos(nn.Module):
    def __init__(self, backbone=resnet50(), mse_loss_ratio = 1, ori_loss_ratio=0, beta=0.99):
        super().__init__()
    ...
    def forward(self, x1, x2,x_ori):
        ...
        L_mse = D(y1, z_ori)/2 + D(y2,z_ori)/2
        L = L_sim + self.mse_loss_ratio * L_mse
