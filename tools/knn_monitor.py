...
def knn_monitor(net, memory_data_loader, test_data_loader, epoch, k=200, t=0.1, hide_progress=False, device = None):
    net.eval()
    ...
    with torch.no_grad():
        ...
        elif hasattr(memory_data_loader.dataset, "labels"):
